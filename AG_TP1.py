...
def correr(conjunto_solucion,cant_corridas):
    subconjunto_poblacion = poblacion_inicial(conjunto_solucion)
    maximos = []
    minimos = []
    promedios = []
